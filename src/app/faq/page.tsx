          ...
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Fitnesspergram is a health-focused meal delivery service that
                  provides calorie-counted, portion-controlled meals designed to
                  support a balanced diet and fitness goals.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Customers can subscribe to our meal plans on our website. We
                  offer a variety of meal options to choose from. Once
                  subscribed, meals are delivered daily based on the chosen
                  plan.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  We offer a range of meals for once a day during lunch hours .
                  Our meals are designed to be nutritious, balanced, and
            ...
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Currently, we deliver in select areas of Narengi, Guwahati. We
                  are working towards expanding our delivery network to cover
            ...
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  We offer flexible subscription plans including weekly and
                  monthly options. Customers can choose the plan that best suits
            ...
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Our meals are freshly prepared and delivered in convenient
                  packaging. They are delivered in bulk at a designated time
                  slot to ensure freshness.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  No, there is no minimum subscription period. Customers can
                  subscribe and cancel their plan at any time.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Although we do not accommodate specific dietary requirements,
                  Please feel free to inform us of any restrictions or
            ...
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  We do not offer a refund on any cancellations. once an order
                  is placed , it can be cancelled any time but no refund will be
